...
const ConfirmationModal: React.FC<ConfirmationModalProps> = ({ isOpen, onClose, onConfirm, title, itemName }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-60 z-50 flex items-center justify-center p-4" aria-modal="true" role="dialog" onClick={onClose}>
            <div className="bg-white rounded-lg shadow-xl w-full max-w-md" role="document" onClick={(e) => e.stopPropagation()}>
                <div className="p-6">
                        ...
                        <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div className="mt-2">
                                <p className="text-sm text-gray-500">
                                    Are you sure you want to remove "<span className="font-semibold text-gray-600">{itemName}</span>"? This action cannot be undone.
                                </p>
                            </div>
                        </div>
                    </div>
