...
type QuestionCount = 'Fewer' | 'Standard' | 'More';
type Difficulty = 'Easy' | 'Medium' | 'Hard';

const QuizModal: React.FC<QuizModalProps> = ({ isOpen, onClose }) => {
    const [questionCount, setQuestionCount] = useState<QuestionCount>('Standard');
    const [difficulty, setDifficulty] = useState<Difficulty>('Medium');
    
    if (!isOpen) return null;

    const questionCountOptions: QuestionCount[] = ['Fewer', 'Standard', 'More'];
            ...
            <div className="bg-white rounded-lg shadow-xl w-full max-w-3xl" role="document" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="flex items-center justify-between p-4 pl-6 border-b border-gray-200">
                    <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-xl font-medium text-gray-800">Customize Quiz</h2>
                    </div>
                        ...
                        <div>
                            ...
                            <div className="inline-flex items-center p-0.5 border border-gray-300 rounded-lg bg-gray-100">
                                {questionCountOptions.map(opt => (
                                    ...
                                    >
                                        {questionCount === opt && <Check className="w-4 h-4" />}
